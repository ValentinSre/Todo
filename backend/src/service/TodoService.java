...
public class TodoService {
  ...
  private void initTodos() {
    final Todo todo1 = new Todo("1", "Sortir les poubelles", 0, "Trier les dechets selon la poubelle");
    final Todo todo2 = new Todo("2", "Relire mon cours", 0, "");
    final Todo todo3 = new Todo("3", "Faire la vaisselle", 0, "");
    final Todo todo4 = new Todo("4", "Faire les courses", 0, "Penser a acheter du beurre");
